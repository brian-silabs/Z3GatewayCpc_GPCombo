...
void sl_util_af_coexistence_get_pta_state(sl_cli_command_arg_t *arguments);
void sl_util_af_coexistence_set_pta_state(sl_cli_command_arg_t *arguments);
void sl_util_af_coexistence_get_pta_options(sl_cli_command_arg_t *arguments);
void sl_util_af_coexistence_set_pta_options(sl_cli_command_arg_t *arguments);
void sl_util_af_coexistence_get_pwm_state(sl_cli_command_arg_t *arguments);
void sl_util_af_coexistence_set_pwm_state(sl_cli_command_arg_t *arguments);
void sl_util_af_coexistence_get_dp_state(sl_cli_command_arg_t *arguments);
void sl_util_af_coexistence_set_dp_state(sl_cli_command_arg_t *arguments);
void sl_util_af_coexistence_clear_counters(sl_cli_command_arg_t *arguments);
void sl_util_af_coexistence_print_counters(sl_cli_command_arg_t *arguments);
void sl_util_af_coexistence_get_phy_state(sl_cli_command_arg_t *arguments);
void sl_util_af_coexistence_set_phy_state(sl_cli_command_arg_t *arguments);
void sl_util_af_coexistence_set_gpio_input_override(sl_cli_command_arg_t *arguments);
void sl_util_af_coexistence_get_gpio_input_override(sl_cli_command_arg_t *arguments);
...
void sl_zigbee_af_green_power_cluster_gp_sink_cli_commissioning_window_extend(sl_cli_command_arg_t *arguments);
void sl_zigbee_af_green_power_server_cli_sink_table_print(sl_cli_command_arg_t *arguments);
void sl_zigbee_af_green_power_server_cli_clear_sink_table(sl_cli_command_arg_t *arguments);
void sl_zigbee_af_green_power_server_cli_run_test_vectors(sl_cli_command_arg_t *arguments);
void sl_zigbee_af_green_power_server_cli_clear_translation_translation_table(sl_cli_command_arg_t *arguments);
void sl_zigbee_af_green_power_server_cli_set_translation_table(sl_cli_command_arg_t *arguments);
void sl_zigbee_af_green_power_server_cli_remove_gpd_endpoint(sl_cli_command_arg_t *arguments);
void sl_zigbee_af_green_power_server_cli_translation_table_print(sl_cli_command_arg_t *arguments);
void sl_zigbee_af_green_power_server_cli_clear_additional_info_block_table(sl_cli_command_arg_t *arguments);
void sl_zigbee_af_green_power_server_cli_set_additional_info_block_table_entry(sl_cli_command_arg_t *arguments);
void sl_zigbee_af_green_power_server_cli_clear_additional_info_block_table_entry(sl_cli_command_arg_t *arguments);
void sl_zigbee_af_green_power_server_cli_additional_info_block_table_print(sl_cli_command_arg_t *arguments);
void sl_zigbee_af_green_power_server_cli_clear_customized_table(sl_cli_command_arg_t *arguments);
void sl_zigbee_af_green_power_server_cli_set_customized_table_entry(sl_cli_command_arg_t *arguments);
void sl_zigbee_af_green_power_server_cli_clear_customized_table_entry(sl_cli_command_arg_t *arguments);
void sl_zigbee_af_green_power_server_cli_customized_table_print(sl_cli_command_arg_t *arguments);
...
void sl_zigbee_af_test_harness_set_node_descriptor_compliance_revision(sl_cli_command_arg_t *arguments);
void sl_zigbee_af_test_harness_set_max_children(sl_cli_command_arg_t *arguments);
void sl_zigbee_af_test_harness_set_neighbor_table_size(sl_cli_command_arg_t *arguments);
...
static const sl_cli_command_info_t cli_cmd_coexistence_get_hyphen_pta_hyphen_state = \
  SL_CLI_COMMAND(sl_util_af_coexistence_get_pta_state,
                 "Get the PTA enable/disable state",
                  "",
                 {SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_coexistence_set_hyphen_pta_hyphen_state = \
  SL_CLI_COMMAND(sl_util_af_coexistence_set_pta_state,
                 "Set the PTA enable/disable state",
                  "PTA state (0=>disable, 1=>enable)" SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_UINT8, SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_coexistence_get_hyphen_pta_hyphen_options = \
  SL_CLI_COMMAND(sl_util_af_coexistence_get_pta_options,
                 "Get the PTA Options",
                  "",
                 {SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_coexistence_set_hyphen_pta_hyphen_options = \
  SL_CLI_COMMAND(sl_util_af_coexistence_set_pta_options,
                 "Set the PTA Options",
                  "PTA Options (see AN1017 Section 4.2)" SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_UINT32, SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_coexistence_get_hyphen_pwm_hyphen_state = \
  SL_CLI_COMMAND(sl_util_af_coexistence_get_pwm_state,
                 "Get the PTA PWM state",
                  "",
                 {SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_coexistence_set_hyphen_pwm_hyphen_state = \
  SL_CLI_COMMAND(sl_util_af_coexistence_set_pwm_state,
                 "Set the PTA PWM state",
                  "PWM period (0.5ms resolution)" SL_CLI_UNIT_SEPARATOR "PWM duty-cycle (%)" SL_CLI_UNIT_SEPARATOR "PWM priority (0=low|1=high)" SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_UINT8, SL_CLI_ARG_UINT8, SL_CLI_ARG_UINT8, SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_coexistence_get_hyphen_dp_hyphen_state = \
  SL_CLI_COMMAND(sl_util_af_coexistence_get_dp_state,
                 "Get the PTA Directional PRIORITY state",
                  "",
                 {SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_coexistence_set_hyphen_dp_hyphen_state = \
  SL_CLI_COMMAND(sl_util_af_coexistence_set_dp_state,
                 "Set the PTA Directional PRIORITY state",
                  "Directional PRIORITY pulse width (us) [0=>bypass]" SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_UINT8, SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_coexistence_reset_hyphen_counters = \
  SL_CLI_COMMAND(sl_util_af_coexistence_clear_counters,
                 "Reset all counters",
                  "",
                 {SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_coexistence_result_hyphen_counters = \
  SL_CLI_COMMAND(sl_util_af_coexistence_print_counters,
                 "Print coexistence specific counters",
                  "",
                 {SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_coexistence_get_hyphen_phy_hyphen_state = \
  SL_CLI_COMMAND(sl_util_af_coexistence_get_phy_state,
                 "Get the PTA PHY Select state",
                  "",
                 {SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_coexistence_set_hyphen_phy_hyphen_state = \
  SL_CLI_COMMAND(sl_util_af_coexistence_set_phy_state,
                 "Set the PTA PHY Select state",
                  "PHY Select Timeout (us) [0=>standard PHY, 1-254=>Timeout to switch to standard PHY after WiFi TX, 255=>Coexistence optimized PHY]" SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_UINT8, SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_coexistence_set_hyphen_gpio_hyphen_input = \
  SL_CLI_COMMAND(sl_util_af_coexistence_set_gpio_input_override,
                 "Override the input value of a coexistence GPIO.",
                  "GPIO port to override" SL_CLI_UNIT_SEPARATOR "Input override value of selected port" SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_UINT8, SL_CLI_ARG_UINT8, SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_coexistence_get_hyphen_gpio_hyphen_input = \
  SL_CLI_COMMAND(sl_util_af_coexistence_get_gpio_input_override,
                 "Get the input value of a coexistence GPIO.",
                  "GPIO index" SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_UINT8, SL_CLI_ARG_END, });
...
static const sl_cli_command_info_t cli_cmd_ezmode_hyphen_commissioning_client = \
  SL_CLI_COMMAND(sl_zigbee_af_ez_mode_commissioning_client_command,
                 "Starts EZ-Mode client commissioning.",
                  "The local endpoint" SL_CLI_UNIT_SEPARATOR "SL_ZIGBEE_AF_EZMODE_COMMISSIONING_SERVER_TO_CLIENT or SL_ZIGBEE_AF_EZMODE_COMMISSIONING_CLIENT_TO_SERVER" SL_CLI_UNIT_SEPARATOR "A list of cluster IDs" SL_CLI_UNIT_SEPARATOR "Array type argument" SL_CLI_UNIT_SEPARATOR,
...
static const sl_cli_command_info_t cli_cmd_ezmode_hyphen_commissioning_server = \
  SL_CLI_COMMAND(sl_zigbee_af_ez_mode_commissioning_server_command,
...
static const sl_cli_command_info_t cli_cmd_green_hyphen_power_hyphen_server_commission = \
  SL_CLI_COMMAND(sl_zigbee_af_green_power_server_commissioning_mode,
                 "Puts the GPS in commissioning mode.",
                  "1 to enter, 0 to leave" SL_CLI_UNIT_SEPARATOR "Green Power Manager (GPM) address for security" SL_CLI_UNIT_SEPARATOR "Green Power Manager (GPM) address for pairing" SL_CLI_UNIT_SEPARATOR "Sink endpoint" SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_UINT8, SL_CLI_ARG_UINT16, SL_CLI_ARG_UINT16, SL_CLI_ARG_UINT8, SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_green_hyphen_power_hyphen_server_extend_hyphen_comm = \
  SL_CLI_COMMAND(sl_zigbee_af_green_power_cluster_gp_sink_cli_commissioning_window_extend,
                 "Extends commissioning window.",
                  "Time in milliseconds" SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_UINT16, SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_green_hyphen_power_hyphen_server_sink_hyphen_table_hyphen_print = \
  SL_CLI_COMMAND(sl_zigbee_af_green_power_server_cli_sink_table_print,
                 "Prints all entries of the sink table.",
                  "",
                 {SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_green_hyphen_power_hyphen_server_sink_hyphen_table_hyphen_clear = \
  SL_CLI_COMMAND(sl_zigbee_af_green_power_server_cli_clear_sink_table,
                 "Clears sink table.",
                  "",
                 {SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_green_hyphen_power_hyphen_server_run_hyphen_test_hyphen_vectors = \
  SL_CLI_COMMAND(sl_zigbee_af_green_power_server_cli_run_test_vectors,
                 "Run security test vectors",
                  "",
                 {SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_green_hyphen_power_hyphen_server_table_hyphen_clear = \
  SL_CLI_COMMAND(sl_zigbee_af_green_power_server_cli_clear_translation_translation_table,
                 "Clears all entries within the translation table.",
                  "",
                 {SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_green_hyphen_power_hyphen_server_table_hyphen_set = \
  SL_CLI_COMMAND(sl_zigbee_af_green_power_server_cli_set_translation_table,
                 "Sets  entry at index within the translation table.",
                  "Index to translation table" SL_CLI_UNIT_SEPARATOR "" SL_CLI_UNIT_SEPARATOR "" SL_CLI_UNIT_SEPARATOR "" SL_CLI_UNIT_SEPARATOR "" SL_CLI_UNIT_SEPARATOR "" SL_CLI_UNIT_SEPARATOR "The endpoint for which the translation is valid" SL_CLI_UNIT_SEPARATOR "" SL_CLI_UNIT_SEPARATOR "" SL_CLI_UNIT_SEPARATOR "" SL_CLI_UNIT_SEPARATOR "" SL_CLI_UNIT_SEPARATOR "" SL_CLI_UNIT_SEPARATOR "" SL_CLI_UNIT_SEPARATOR "" SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_UINT8, SL_CLI_ARG_UINT16, SL_CLI_ARG_HEX, SL_CLI_ARG_UINT8, SL_CLI_ARG_UINT32, SL_CLI_ARG_UINT8, SL_CLI_ARG_UINT8, SL_CLI_ARG_UINT16, SL_CLI_ARG_UINT16, SL_CLI_ARG_UINT16, SL_CLI_ARG_UINT8, SL_CLI_ARG_HEX, SL_CLI_ARG_UINT8, SL_CLI_ARG_HEX, SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_green_hyphen_power_hyphen_server_table_hyphen_remove_hyphen_endpoint = \
  SL_CLI_COMMAND(sl_zigbee_af_green_power_server_cli_remove_gpd_endpoint,
                 "Removes GPD  entry from the translation table for the specified endpoint.",
                  "" SL_CLI_UNIT_SEPARATOR "" SL_CLI_UNIT_SEPARATOR "" SL_CLI_UNIT_SEPARATOR "" SL_CLI_UNIT_SEPARATOR "The endpoint for which the translation is valid" SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_UINT8, SL_CLI_ARG_UINT32, SL_CLI_ARG_HEX, SL_CLI_ARG_UINT8, SL_CLI_ARG_UINT8, SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_green_hyphen_power_hyphen_server_table_hyphen_print = \
  SL_CLI_COMMAND(sl_zigbee_af_green_power_server_cli_translation_table_print,
                 "Prints all entries of the translation table.",
                  "",
                 {SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_green_hyphen_power_hyphen_server_additionalInfoTable_hyphen_clearAll = \
  SL_CLI_COMMAND(sl_zigbee_af_green_power_server_cli_clear_additional_info_block_table,
                 "Clears all entries within the additionalInfoTable.",
                  "",
                 {SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_green_hyphen_power_hyphen_server_additionalInfoTable_hyphen_setEntry = \
  SL_CLI_COMMAND(sl_zigbee_af_green_power_server_cli_set_additional_info_block_table_entry,
                 "Sets entry at index within the additionalInfoTable.",
                  "Index to additionalInfoBlock table" SL_CLI_UNIT_SEPARATOR "" SL_CLI_UNIT_SEPARATOR "" SL_CLI_UNIT_SEPARATOR "" SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_UINT8, SL_CLI_ARG_UINT8, SL_CLI_ARG_UINT8, SL_CLI_ARG_STRING, SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_green_hyphen_power_hyphen_server_additionalInfoTable_hyphen_clearEntry = \
  SL_CLI_COMMAND(sl_zigbee_af_green_power_server_cli_clear_additional_info_block_table_entry,
                 "Clears entry at index within the additionalInfoTable.",
                  "Index to additionalInfoBlock table" SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_UINT8, SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_green_hyphen_power_hyphen_server_additionalInfoTable_hyphen_print = \
  SL_CLI_COMMAND(sl_zigbee_af_green_power_server_cli_additional_info_block_table_print,
                 "Prints all entries of the additionalInfoTable.",
                  "",
                 {SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_green_hyphen_power_hyphen_server_customizedTable_hyphen_clearAll = \
  SL_CLI_COMMAND(sl_zigbee_af_green_power_server_cli_clear_customized_table,
                 "Clears all entries within the customizedTable.",
                  "",
                 {SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_green_hyphen_power_hyphen_server_customizedTable_hyphen_setEntry = \
  SL_CLI_COMMAND(sl_zigbee_af_green_power_server_cli_set_customized_table_entry,
                 "Sets entry at index within the customizedTable.",
                  "Index to customized table" SL_CLI_UNIT_SEPARATOR "" SL_CLI_UNIT_SEPARATOR "The endpoint for which the translation is valid" SL_CLI_UNIT_SEPARATOR "" SL_CLI_UNIT_SEPARATOR "" SL_CLI_UNIT_SEPARATOR "" SL_CLI_UNIT_SEPARATOR "" SL_CLI_UNIT_SEPARATOR "" SL_CLI_UNIT_SEPARATOR "" SL_CLI_UNIT_SEPARATOR "" SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_UINT8, SL_CLI_ARG_UINT8, SL_CLI_ARG_UINT8, SL_CLI_ARG_UINT16, SL_CLI_ARG_UINT16, SL_CLI_ARG_UINT8, SL_CLI_ARG_UINT16, SL_CLI_ARG_UINT8, SL_CLI_ARG_UINT8, SL_CLI_ARG_STRING, SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_green_hyphen_power_hyphen_server_customizedTable_hyphen_clearEntry = \
  SL_CLI_COMMAND(sl_zigbee_af_green_power_server_cli_clear_customized_table_entry,
                 "Clears entry at index within the customizedTable.",
                  "Index to customized table" SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_UINT8, SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_green_hyphen_power_hyphen_server_customizedTable_hyphen_print = \
  SL_CLI_COMMAND(sl_zigbee_af_green_power_server_cli_customized_table_print,
                 "Prints all entries of the customizedTable.",
                  "",
                 {SL_CLI_ARG_END, });
...
static const sl_cli_command_info_t cli_cmd_test_hyphen_harness_status = \
  SL_CLI_COMMAND(sl_zigbee_af_test_harness_status_command,
...
static const sl_cli_command_info_t cli_cmd_aps_hyphen_sec_hyphen_for_hyphen_cluster_on = \
  SL_CLI_COMMAND(sl_zigbee_af_test_harness_set_aps_security_for_cluster_command,
...
static const sl_cli_command_info_t cli_cmd_registration_on = \
  SL_CLI_COMMAND(sl_zigbee_af_test_harness_set_registration_command,
...
static const sl_cli_command_info_t cli_cmd_key_hyphen_establishment_normal_hyphen_mode = \
  SL_CLI_COMMAND(sl_zigbee_af_test_harness_key_establishment_set_mode_command,
...
static const sl_cli_command_info_t cli_cmd_cert_hyphen_mangle_length = \
  SL_CLI_COMMAND(sl_zigbee_af_test_harness_cert_mangle_command,
...
static const sl_cli_command_info_t cli_cmd_key_hyphen_establishment_suite = \
  SL_CLI_COMMAND(sl_zigbee_af_test_harness_key_establishment_select_suite_command,
                 "Selects between the CBKE 163k1 and 283k1 suites.",
                  "Holds the type        of key establishment suite. It can be SL_ZIGBEE_AF_CBKE_KEY_ESTABLISHMENT_SUITE_163K1,        SL_ZIGBEE_AF_CBKE_KEY_ESTABLISHMENT_SUITE_283K1, or        SL_ZIGBEE_AF_INVALID_KEY_ESTABLISHMENT_SUITE" SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_UINT16, SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_key_hyphen_establishment_set_hyphen_available_hyphen_suite = \
  SL_CLI_COMMAND(sl_zigbee_af_test_harness_key_establishment_set_available_suite_command,
                 "Selects between the CBKE 163k1 and 283k1 suites.",
                  "Holds the type        of key establishment suite. It can be SL_ZIGBEE_AF_CBKE_KEY_ESTABLISHMENT_SUITE_163K1,        SL_ZIGBEE_AF_CBKE_KEY_ESTABLISHMENT_SUITE_283K1, or        SL_ZIGBEE_AF_INVALID_KEY_ESTABLISHMENT_SUITE" SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_UINT16, SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_key_hyphen_establishment_key_hyphen_mangle = \
  SL_CLI_COMMAND(sl_zigbee_af_test_harness_key_establishment_key_mangle_command,
                 "Mangles the length of the ephemeral key.",
                  "The positive or negative change in length" SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_INT8, SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_price_send_hyphen_new_hyphen_fields = \
  SL_CLI_COMMAND(sl_zigbee_af_test_harness_price_send_new_fields_command,
...
static const sl_cli_command_info_t cli_cmd_tc_hyphen_keepalive_send = \
  SL_CLI_COMMAND(sl_zigbee_af_test_harness_tc_keepalive_send_command,
                 "Sends a Trust Center Keepalive.",
                  "",
                 {SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_tc_hyphen_keepalive_start = \
  SL_CLI_COMMAND(sl_zigbee_af_test_harness_tc_keepalive_start_stop_command,
...
static const sl_cli_command_info_t cli_cmd_ota_image_hyphen_mangle = \
  SL_CLI_COMMAND(sl_zigbee_af_test_harness_ota_image_mangle_command,
...
static const sl_cli_command_info_t cli_cmd_test_hyphen_harness_concentrator_hyphen_start = \
  SL_CLI_COMMAND(sl_zigbee_af_test_harness_concentrator_start_stop_command,
...
static const sl_cli_command_info_t cli_cmd_key_hyphen_update_unicast = \
  SL_CLI_COMMAND(sl_zigbee_af_test_harness_key_update_command,
...
static const sl_cli_command_info_t cli_cmd_limit_hyphen_beacons_on = \
  SL_CLI_COMMAND(sl_zigbee_af_test_harness_limit_beacons_on_off_command,
...
static const sl_cli_command_info_t cli_cmd_endpoint_enable = \
  SL_CLI_COMMAND(sl_zigbee_af_test_harness_enable_disable_endpoint_command,
...
static const sl_cli_command_info_t cli_cmd_endpoint_status = \
  SL_CLI_COMMAND(sl_zigbee_af_test_harness_endpoint_status_command,
                 "Disables the endpoint to receive messages and be discovered.",
                  "",
                 {SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_endpoint_cluster_hyphen_endpoint_hyphen_index = \
  SL_CLI_COMMAND(sl_zigbee_af_test_harness_cluster_endpoint_index_command,
...
static const sl_cli_command_info_t cli_cmd_radio_on = \
  SL_CLI_COMMAND(sl_zigbee_af_test_harness_radio_on_off_command,
...
static const sl_cli_command_info_t cli_cmd_test_hyphen_harness_set_hyphen_radio_hyphen_power = \
  SL_CLI_COMMAND(sl_zigbee_af_test_harness_set_radio_power,
...
static const sl_cli_command_info_t cli_cmd_test_hyphen_harness_add_hyphen_child = \
  SL_CLI_COMMAND(sl_zigbee_af_test_harness_add_child_command,
...
static const sl_cli_command_info_t cli_cmd_test_hyphen_harness_set_hyphen_compliance_hyphen_revision = \
  SL_CLI_COMMAND(sl_zigbee_af_test_harness_set_node_descriptor_compliance_revision,
...
static const sl_cli_command_info_t cli_cmd_test_hyphen_harness_set_hyphen_max_hyphen_children = \
  SL_CLI_COMMAND(sl_zigbee_af_test_harness_set_max_children,
...
static const sl_cli_command_info_t cli_cmd_test_hyphen_harness_set_hyphen_neighbor_hyphen_table_hyphen_size = \
  SL_CLI_COMMAND(sl_zigbee_af_test_harness_set_neighbor_table_size,
...
static const sl_cli_command_entry_t coexistence_group_table[] = {
  { "get-pta-state", &cli_cmd_coexistence_get_hyphen_pta_hyphen_state, false },
  { "set-pta-state", &cli_cmd_coexistence_set_hyphen_pta_hyphen_state, false },
  { "get-pta-options", &cli_cmd_coexistence_get_hyphen_pta_hyphen_options, false },
  { "set-pta-options", &cli_cmd_coexistence_set_hyphen_pta_hyphen_options, false },
  { "get-pwm-state", &cli_cmd_coexistence_get_hyphen_pwm_hyphen_state, false },
  { "set-pwm-state", &cli_cmd_coexistence_set_hyphen_pwm_hyphen_state, false },
  { "get-dp-state", &cli_cmd_coexistence_get_hyphen_dp_hyphen_state, false },
  { "set-dp-state", &cli_cmd_coexistence_set_hyphen_dp_hyphen_state, false },
  { "reset-counters", &cli_cmd_coexistence_reset_hyphen_counters, false },
  { "result-counters", &cli_cmd_coexistence_result_hyphen_counters, false },
  { "get-phy-state", &cli_cmd_coexistence_get_hyphen_phy_hyphen_state, false },
  { "set-phy-state", &cli_cmd_coexistence_set_hyphen_phy_hyphen_state, false },
  { "set-gpio-input", &cli_cmd_coexistence_set_hyphen_gpio_hyphen_input, false },
  { "get-gpio-input", &cli_cmd_coexistence_get_hyphen_gpio_hyphen_input, false },
  { NULL, NULL, false },
};
static const sl_cli_command_info_t cli_cmd_grp_coexistence = \
  SL_CLI_COMMAND_GROUP(coexistence_group_table, "The coexistence commands allow you run-time reconfigure coexistence PTA");
...
static const sl_cli_command_entry_t green_hyphen_power_hyphen_server_group_table[] = {
  { "commission", &cli_cmd_green_hyphen_power_hyphen_server_commission, false },
  { "extend-comm", &cli_cmd_green_hyphen_power_hyphen_server_extend_hyphen_comm, false },
  { "sink-table-print", &cli_cmd_green_hyphen_power_hyphen_server_sink_hyphen_table_hyphen_print, false },
  { "sink-table-clear", &cli_cmd_green_hyphen_power_hyphen_server_sink_hyphen_table_hyphen_clear, false },
  { "run-test-vectors", &cli_cmd_green_hyphen_power_hyphen_server_run_hyphen_test_hyphen_vectors, false },
  { "table-clear", &cli_cmd_green_hyphen_power_hyphen_server_table_hyphen_clear, false },
  { "table-set", &cli_cmd_green_hyphen_power_hyphen_server_table_hyphen_set, false },
  { "table-remove-endpoint", &cli_cmd_green_hyphen_power_hyphen_server_table_hyphen_remove_hyphen_endpoint, false },
  { "table-print", &cli_cmd_green_hyphen_power_hyphen_server_table_hyphen_print, false },
  { "additionalInfoTable-clearAll", &cli_cmd_green_hyphen_power_hyphen_server_additionalInfoTable_hyphen_clearAll, false },
  { "additionalInfoTable-setEntry", &cli_cmd_green_hyphen_power_hyphen_server_additionalInfoTable_hyphen_setEntry, false },
  { "additionalInfoTable-clearEntry", &cli_cmd_green_hyphen_power_hyphen_server_additionalInfoTable_hyphen_clearEntry, false },
  { "additionalInfoTable-print", &cli_cmd_green_hyphen_power_hyphen_server_additionalInfoTable_hyphen_print, false },
  { "customizedTable-clearAll", &cli_cmd_green_hyphen_power_hyphen_server_customizedTable_hyphen_clearAll, false },
  { "customizedTable-setEntry", &cli_cmd_green_hyphen_power_hyphen_server_customizedTable_hyphen_setEntry, false },
  { "customizedTable-clearEntry", &cli_cmd_green_hyphen_power_hyphen_server_customizedTable_hyphen_clearEntry, false },
  { "customizedTable-print", &cli_cmd_green_hyphen_power_hyphen_server_customizedTable_hyphen_print, false },
  { NULL, NULL, false },
};
static const sl_cli_command_info_t cli_cmd_grp_green_hyphen_power_hyphen_server = \
  SL_CLI_COMMAND_GROUP(green_hyphen_power_hyphen_server_group_table, "green-power-server related commands.");
...
static const sl_cli_command_entry_t plugin_group_table[] = {
  ...
  { "coexistence", &cli_cmd_grp_coexistence, false },
  ...
  { "green-power-server", &cli_cmd_grp_green_hyphen_power_hyphen_server, false },
