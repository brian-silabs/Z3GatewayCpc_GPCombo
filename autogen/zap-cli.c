...
void sli_zigbee_cli_zcl_ias_zone_enroll_command(sl_cli_command_arg_t *arguments);
void sli_zigbee_cli_zcl_ias_zone_sc_command(sl_cli_command_arg_t *arguments);
...
static const sl_cli_command_info_t cli_cmd_zcl_ias_zone_cluster_zone_enroll_request = \
SL_CLI_COMMAND(sli_zigbee_cli_zcl_ias_zone_enroll_command,
            "Command description for zoneEnrollRequest",
            "zone type" SL_CLI_UNIT_SEPARATOR "manufacturer code" SL_CLI_UNIT_SEPARATOR ,
            {
                SL_CLI_ARG_UINT16,
                SL_CLI_ARG_UINT16,
                SL_CLI_ARG_END,
...
static const sl_cli_command_info_t cli_cmd_zcl_ias_zone_cluster_zone_status_change_notification = \
SL_CLI_COMMAND(sli_zigbee_cli_zcl_ias_zone_sc_command,
            "Command description for zoneStatusChangeNotification",
            "zone status" SL_CLI_UNIT_SEPARATOR "extended status" SL_CLI_UNIT_SEPARATOR "zone id" SL_CLI_UNIT_SEPARATOR "delay" SL_CLI_UNIT_SEPARATOR ,
            {
                SL_CLI_ARG_UINT16,
                SL_CLI_ARG_UINT8,
                SL_CLI_ARG_UINT8,
...
static const sl_cli_command_entry_t zcl_ias_zone_cluster_command_table[] = {
    { "sc", &cli_cmd_zcl_ias_zone_cluster_zone_status_change_notification, false },
    { "enroll", &cli_cmd_zcl_ias_zone_cluster_zone_enroll_request, false },
    { NULL, NULL, false },
};
...
static const sl_cli_command_info_t cli_cmd_ias_zone_group = \
  SL_CLI_COMMAND_GROUP(zcl_ias_zone_cluster_command_table, "ZCL ias_zone cluster commands");
...
static const sl_cli_command_entry_t zcl_group_table[] = {
  ...
  { "ias-zone", &cli_cmd_ias_zone_group, false },
...
WEAK(void sli_zigbee_cli_zcl_ias_zone_enroll_command(sl_cli_command_arg_t *arguments)) {
  uint8_t argumentTypes[2] =  { 
    SL_ZCL_CLI_ARG_UINT16,
    SL_ZCL_CLI_ARG_UINT16
  }; 
...
WEAK(void sli_zigbee_cli_zcl_ias_zone_sc_command(sl_cli_command_arg_t *arguments)) {
  uint8_t argumentTypes[4] =  { 
    SL_ZCL_CLI_ARG_UINT16,
    SL_ZCL_CLI_ARG_UINT8,
    SL_ZCL_CLI_ARG_UINT8,
