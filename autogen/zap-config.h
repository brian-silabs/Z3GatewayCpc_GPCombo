...
#define ZCL_GENERATED_ATTRIBUTE_COUNT (49)
...
#define ZCL_GENERATED_ATTRIBUTES { \
  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT| ATTRIBUTE_MASK_SINGLETON), { (uint8_t*)3  } }, /* 0 Cluster: Basic, Attribute: cluster revision, Side: client*/ \
	  ...
	  { 0x0001, ZCL_BITMAP8_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_WRITABLE| ATTRIBUTE_MASK_SINGLETON), { (uint8_t*)0x00  } }, /* 16 Cluster: Time, Attribute: time status, Side: server*/ \
		  ...
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)3  } }, /* 26 Cluster: Color Control, Attribute: cluster revision, Side: client*/ \
		  { 0x0002, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x0000  } }, /* 27 Cluster: Color Control, Attribute: remaining time, Side: server*/ \
		  { 0x0003, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x616B  } }, /* 28 Cluster: Color Control, Attribute: current x, Side: server*/ \
		  { 0x0004, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x607D  } }, /* 29 Cluster: Color Control, Attribute: current y, Side: server*/ \
		  { 0x0008, ZCL_ENUM8_ATTRIBUTE_TYPE, 1, (0x00), { (uint8_t*)0x01  } }, /* 30 Cluster: Color Control, Attribute: color mode, Side: server*/ \
		  { 0x000F, ZCL_BITMAP8_ATTRIBUTE_TYPE, 1, (ATTRIBUTE_MASK_WRITABLE), { (uint8_t*)0x00  } }, /* 31 Cluster: Color Control, Attribute: color control options, Side: server*/ \
		  { 0x0010, ZCL_INT8U_ATTRIBUTE_TYPE, 1, (0x00), { (uint8_t*)0x00  } }, /* 32 Cluster: Color Control, Attribute: number of primaries, Side: server*/ \
		  { 0x4001, ZCL_ENUM8_ATTRIBUTE_TYPE, 1, (0x00), { (uint8_t*)0x01  } }, /* 33 Cluster: Color Control, Attribute: enhanced color mode, Side: server*/ \
		  { 0x400A, ZCL_BITMAP16_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x0000  } }, /* 34 Cluster: Color Control, Attribute: color capabilities, Side: server*/ \
		  { 0x400B, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x0000  } }, /* 35 Cluster: Color Control, Attribute: color temp physical min, Side: server*/ \
		  { 0x400C, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0xFEFF  } }, /* 36 Cluster: Color Control, Attribute: color temp physical max, Side: server*/ \
		  { 0x400D, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)0x00  } }, /* 37 Cluster: Color Control, Attribute: couple color temp to level min-mireds, Side: server*/ \
		  { 0x4010, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_WRITABLE), { (uint8_t*)0x00  } }, /* 38 Cluster: Color Control, Attribute: start up color temperature mireds, Side: server*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (0x00), { (uint8_t*)3  } }, /* 39 Cluster: Color Control, Attribute: cluster revision, Side: server*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)2  } }, /* 40 Cluster: Illuminance Measurement, Attribute: cluster revision, Side: client*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)3  } }, /* 41 Cluster: Temperature Measurement, Attribute: cluster revision, Side: client*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)2  } }, /* 42 Cluster: Relative Humidity Measurement, Attribute: cluster revision, Side: client*/ \
		  ...
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)2  } }, /* 44 Cluster: IAS Zone, Attribute: cluster revision, Side: client*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)2  } }, /* 45 Cluster: Simple Metering, Attribute: cluster revision, Side: client*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)2  } }, /* 46 Cluster: Meter Identification, Attribute: cluster revision, Side: client*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)0x0001  } }, /* 47 Cluster: Appliance Statistics, Attribute: cluster revision, Side: client*/ \
		  { 0xFFFD, ZCL_INT16U_ATTRIBUTE_TYPE, 2, (ATTRIBUTE_MASK_CLIENT), { (uint8_t*)3  } } /* 48 Cluster: Electrical Measurement, Attribute: cluster revision, Side: client*/ \
		 }

 

#define ZCL_GENERATED_CLUSTER_COUNT (25)
...
#define ZCL_GENERATED_CLUSTERS { \
  { 0x0000, (sl_zigbee_af_attribute_metadata_t*)&(generatedAttributes[0]), 1, 0, CLUSTER_MASK_CLIENT, NULL }, /* 0, Endpoint Id: 1, Cluster: Basic, Side: client*/ \
	  ...
	  { 0x0005, (sl_zigbee_af_attribute_metadata_t*)&(generatedAttributes[8]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 5, Endpoint Id: 1, Cluster: Scenes, Side: client*/ \
	  { 0x0006, (sl_zigbee_af_attribute_metadata_t*)&(generatedAttributes[9]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 6, Endpoint Id: 1, Cluster: On/off, Side: client*/ \
	  { 0x0006, (sl_zigbee_af_attribute_metadata_t*)&(generatedAttributes[10]), 2, 3, CLUSTER_MASK_SERVER, NULL }, /* 7, Endpoint Id: 1, Cluster: On/off, Side: server*/ \
	  { 0x0008, (sl_zigbee_af_attribute_metadata_t*)&(generatedAttributes[12]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 8, Endpoint Id: 1, Cluster: Level Control, Side: client*/ \
	  { 0x0008, (sl_zigbee_af_attribute_metadata_t*)&(generatedAttributes[13]), 2, 3, CLUSTER_MASK_SERVER, NULL }, /* 9, Endpoint Id: 1, Cluster: Level Control, Side: server*/ \
	  { 0x000A, (sl_zigbee_af_attribute_metadata_t*)&(generatedAttributes[15]), 3, 0, CLUSTER_MASK_SERVER, NULL }, /* 10, Endpoint Id: 1, Cluster: Time, Side: server*/ \
	  { 0x0019, (sl_zigbee_af_attribute_metadata_t*)&(generatedAttributes[18]), 1, 2, CLUSTER_MASK_SERVER, NULL }, /* 11, Endpoint Id: 1, Cluster: Over the Air Bootloading, Side: server*/ \
	  { 0x001A, (sl_zigbee_af_attribute_metadata_t*)&(generatedAttributes[19]), 6, 7, CLUSTER_MASK_SERVER, NULL }, /* 12, Endpoint Id: 1, Cluster: Power Profile, Side: server*/ \
	  { 0x0020, (sl_zigbee_af_attribute_metadata_t*)&(generatedAttributes[25]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 13, Endpoint Id: 1, Cluster: Poll Control, Side: client*/ \
	  { 0x0300, (sl_zigbee_af_attribute_metadata_t*)&(generatedAttributes[26]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 14, Endpoint Id: 1, Cluster: Color Control, Side: client*/ \
	  { 0x0300, (sl_zigbee_af_attribute_metadata_t*)&(generatedAttributes[27]), 13, 22, CLUSTER_MASK_SERVER, NULL }, /* 15, Endpoint Id: 1, Cluster: Color Control, Side: server*/ \
	  { 0x0400, (sl_zigbee_af_attribute_metadata_t*)&(generatedAttributes[40]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 16, Endpoint Id: 1, Cluster: Illuminance Measurement, Side: client*/ \
	  { 0x0402, (sl_zigbee_af_attribute_metadata_t*)&(generatedAttributes[41]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 17, Endpoint Id: 1, Cluster: Temperature Measurement, Side: client*/ \
	  { 0x0405, (sl_zigbee_af_attribute_metadata_t*)&(generatedAttributes[42]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 18, Endpoint Id: 1, Cluster: Relative Humidity Measurement, Side: client*/ \
	  { 0x0406, (sl_zigbee_af_attribute_metadata_t*)&(generatedAttributes[43]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 19, Endpoint Id: 1, Cluster: Occupancy Sensing, Side: client*/ \
	  { 0x0500, (sl_zigbee_af_attribute_metadata_t*)&(generatedAttributes[44]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 20, Endpoint Id: 1, Cluster: IAS Zone, Side: client*/ \
	  { 0x0702, (sl_zigbee_af_attribute_metadata_t*)&(generatedAttributes[45]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 21, Endpoint Id: 1, Cluster: Simple Metering, Side: client*/ \
	  { 0x0B01, (sl_zigbee_af_attribute_metadata_t*)&(generatedAttributes[46]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 22, Endpoint Id: 1, Cluster: Meter Identification, Side: client*/ \
	  { 0x0B03, (sl_zigbee_af_attribute_metadata_t*)&(generatedAttributes[47]), 1, 2, CLUSTER_MASK_CLIENT, NULL }, /* 23, Endpoint Id: 1, Cluster: Appliance Statistics, Side: client*/ \
	  { 0x0B04, (sl_zigbee_af_attribute_metadata_t*)&(generatedAttributes[48]), 1, 2, CLUSTER_MASK_CLIENT, NULL } /* 24, Endpoint Id: 1, Cluster: Electrical Measurement, Side: client*/ \
	 }
...
#define ZCL_GENERATED_ENDPOINT_TYPES { \
  { ((sl_zigbee_af_cluster_t*)&(generatedClusters[0])), 25, 73 }, \
	 } 
...
#define SL_ZIGBEE_ZCL_GENERATED_COMMAND_COUNT  (94)
#define ZCL_GENERATED_COMMANDS { \
  { 0x0000, 0x00, COMMAND_MASK_INCOMING_SERVER }, /* 0, Cluster: Basic, Command: ResetToFactoryDefaults*/ \
	  ...
	  { 0x0300, 0x00, COMMAND_MASK_INCOMING_SERVER }, /* 67, Cluster: Color Control, Command: MoveToHue*/ \
	  { 0x0300, 0x01, COMMAND_MASK_INCOMING_SERVER }, /* 68, Cluster: Color Control, Command: MoveHue*/ \
	  { 0x0300, 0x02, COMMAND_MASK_INCOMING_SERVER }, /* 69, Cluster: Color Control, Command: StepHue*/ \
	  { 0x0300, 0x03, COMMAND_MASK_INCOMING_SERVER }, /* 70, Cluster: Color Control, Command: MoveToSaturation*/ \
	  { 0x0300, 0x04, COMMAND_MASK_INCOMING_SERVER }, /* 71, Cluster: Color Control, Command: MoveSaturation*/ \
	  { 0x0300, 0x05, COMMAND_MASK_INCOMING_SERVER }, /* 72, Cluster: Color Control, Command: StepSaturation*/ \
	  { 0x0300, 0x06, COMMAND_MASK_INCOMING_SERVER }, /* 73, Cluster: Color Control, Command: MoveToHueAndSaturation*/ \
	  { 0x0300, 0x07, COMMAND_MASK_INCOMING_SERVER | COMMAND_MASK_OUTGOING_CLIENT }, /* 74, Cluster: Color Control, Command: MoveToColor*/ \
	  { 0x0300, 0x08, COMMAND_MASK_INCOMING_SERVER | COMMAND_MASK_OUTGOING_CLIENT }, /* 75, Cluster: Color Control, Command: MoveColor*/ \
	  { 0x0300, 0x09, COMMAND_MASK_INCOMING_SERVER | COMMAND_MASK_OUTGOING_CLIENT }, /* 76, Cluster: Color Control, Command: StepColor*/ \
	  { 0x0300, 0x0A, COMMAND_MASK_INCOMING_SERVER }, /* 77, Cluster: Color Control, Command: MoveToColorTemperature*/ \
	  { 0x0300, 0x4B, COMMAND_MASK_INCOMING_SERVER }, /* 78, Cluster: Color Control, Command: MoveColorTemperature*/ \
	  { 0x0300, 0x4C, COMMAND_MASK_INCOMING_SERVER }, /* 79, Cluster: Color Control, Command: StepColorTemperature*/ \
	  { 0x0500, 0x00, COMMAND_MASK_OUTGOING_CLIENT }, /* 80, Cluster: IAS Zone, Command: ZoneEnrollResponse*/ \
	  { 0x0500, 0x00, COMMAND_MASK_INCOMING_CLIENT }, /* 81, Cluster: IAS Zone, Command: ZoneStatusChangeNotification*/ \
	  { 0x0500, 0x01, COMMAND_MASK_INCOMING_CLIENT }, /* 82, Cluster: IAS Zone, Command: ZoneEnrollRequest*/ \
	  { 0x0702, 0x00, COMMAND_MASK_INCOMING_CLIENT }, /* 83, Cluster: Simple Metering, Command: GetProfileResponse*/ \
	  { 0x0702, 0x01, COMMAND_MASK_INCOMING_CLIENT }, /* 84, Cluster: Simple Metering, Command: RequestMirror*/ \
	  { 0x0702, 0x02, COMMAND_MASK_INCOMING_CLIENT }, /* 85, Cluster: Simple Metering, Command: RemoveMirror*/ \
	  { 0x0702, 0x03, COMMAND_MASK_INCOMING_CLIENT }, /* 86, Cluster: Simple Metering, Command: RequestFastPollModeResponse*/ \
	  { 0x0702, 0x0C, COMMAND_MASK_INCOMING_CLIENT }, /* 87, Cluster: Simple Metering, Command: SupplyStatusResponse*/ \
	  { 0x0B03, 0x00, COMMAND_MASK_INCOMING_CLIENT }, /* 88, Cluster: Appliance Statistics, Command: LogNotification*/ \
	  { 0x0B03, 0x00, COMMAND_MASK_OUTGOING_CLIENT }, /* 89, Cluster: Appliance Statistics, Command: LogRequest*/ \
	  { 0x0B03, 0x01, COMMAND_MASK_OUTGOING_CLIENT }, /* 90, Cluster: Appliance Statistics, Command: LogQueueRequest*/ \
	  { 0x0B03, 0x01, COMMAND_MASK_INCOMING_CLIENT }, /* 91, Cluster: Appliance Statistics, Command: LogResponse*/ \
	  { 0x0B03, 0x02, COMMAND_MASK_INCOMING_CLIENT }, /* 92, Cluster: Appliance Statistics, Command: LogQueueResponse*/ \
	  { 0x0B03, 0x03, COMMAND_MASK_INCOMING_CLIENT }, /* 93, Cluster: Appliance Statistics, Command: StatisticsAvailable*/ \
	 } 
...
#define SL_ZIGBEE_ZCL_GENERATED_REPORTING_CONFIG_DEFAULTS_TABLE_SIZE (6)
#define SL_ZIGBEE_ZCL_GENERATED_REPORTING_CONFIG_DEFAULTS { \
  { SL_ZIGBEE_ZCL_REPORTING_DIRECTION_REPORTED, 0x0001, 0x0006, 0x0000, CLUSTER_MASK_SERVER, 0x0000, 1, 65534, 0 }, /* Endpoint Id: 1, Cluster: On/off, Attribute: on/off */ \
	  ...
	  { SL_ZIGBEE_ZCL_REPORTING_DIRECTION_REPORTED, 0x0001, 0x001A, 0x0003, CLUSTER_MASK_SERVER, 0x0000, 1, 65534, 0 }, /* Endpoint Id: 1, Cluster: Power Profile, Attribute: energy remote */ \
	  { SL_ZIGBEE_ZCL_REPORTING_DIRECTION_REPORTED, 0x0001, 0x001A, 0x0004, CLUSTER_MASK_SERVER, 0x0000, 1, 65534, 0 }, /* Endpoint Id: 1, Cluster: Power Profile, Attribute: schedule mode */ \
	  { SL_ZIGBEE_ZCL_REPORTING_DIRECTION_REPORTED, 0x0001, 0x0300, 0x0003, CLUSTER_MASK_SERVER, 0x0000, 1, 65534, 0 }, /* Endpoint Id: 1, Cluster: Color Control, Attribute: current x */ \
	  { SL_ZIGBEE_ZCL_REPORTING_DIRECTION_REPORTED, 0x0001, 0x0300, 0x0004, CLUSTER_MASK_SERVER, 0x0000, 1, 65534, 0 }, /* Endpoint Id: 1, Cluster: Color Control, Attribute: current y */ \
	 } 
...
#define SL_ZIGBEE_ZCL_SCENES_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
...
#define SL_ZIGBEE_ZCL_POWER_PROFILE_CLUSTER_SERVER_ENDPOINT_COUNT (1)
...
#define SL_ZIGBEE_ZCL_ILLUM_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define SL_ZIGBEE_ZCL_TEMP_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define SL_ZIGBEE_ZCL_RELATIVE_HUMIDITY_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define SL_ZIGBEE_ZCL_OCCUPANCY_SENSING_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
#define SL_ZIGBEE_ZCL_IAS_ZONE_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
...
#define SL_ZIGBEE_ZCL_ELECTRICAL_MEASUREMENT_CLUSTER_CLIENT_ENDPOINT_COUNT (1)
