...
sl_zigbee_af_status_t sl_zigbee_af_time_cluster_server_pre_attribute_changed_cb (uint8_t endpoint, sl_zigbee_af_attribute_id_t attributeId, sl_zigbee_af_attribute_type_t attributeType, uint8_t size, uint8_t * value);
...
#define GENERATED_FUNCTION_STRUCTURES_ARRAY  { \
  ...
  {\
    ...
    (sl_zigbee_af_generic_cluster_function_t)sl_zigbee_af_ias_zone_cluster_client_init_cb\
  },\
  {\
    3u,\
    (CLUSTER_MASK_SERVER | CLUSTER_MASK_INIT_FUNCTION),\
  ...
  {\
    10u,\
    (CLUSTER_MASK_SERVER | CLUSTER_MASK_INIT_FUNCTION),\
    (sl_zigbee_af_generic_cluster_function_t)sl_zigbee_af_time_cluster_server_init_cb\
  },\
  {\
    10u,\
    (CLUSTER_MASK_SERVER | CLUSTER_MASK_PRE_ATTRIBUTE_CHANGED_FUNCTION),\
    (sl_zigbee_af_generic_cluster_function_t)sl_zigbee_af_time_cluster_server_pre_attribute_changed_cb\
  },\
  { 0x8000u,\
    0x00u,\
