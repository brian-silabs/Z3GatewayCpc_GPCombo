...
void sli_zigbee_af_event_init(void)
{
  ...
  sli_zigbee_af_ezmode_commissioning_init_callback(SL_ZIGBEE_INIT_LEVEL_EVENT);
  sli_zigbee_af_identify_init_callback(SL_ZIGBEE_INIT_LEVEL_EVENT);
  ...
  sli_zigbee_af_test_harness_init_callback(SL_ZIGBEE_INIT_LEVEL_EVENT);
  sli_zigbee_af_trust_center_nwk_key_update_broadcast_init_callback(SL_ZIGBEE_INIT_LEVEL_EVENT);
