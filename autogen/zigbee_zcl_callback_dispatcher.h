...
void sl_zigbee_af_ias_zone_client_zdo_message_received_cb(sl_802154_short_addr_t sender, sl_zigbee_aps_frame_t* apsFrame, uint8_t* message, uint16_t length);
